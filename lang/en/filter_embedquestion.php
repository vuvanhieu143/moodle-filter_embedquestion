...
$string['invalidquestion'] = 'The question with idnumber "{$a->qid}" does not exist in category "{$a->errortext}".';
...
$string['questionhaschanged'] = 'This question has been changed since you started working on it.';
...
$string['restartwithnewversion'] = 'Restart with the latest version';
