...
class utils {
    ...
    /**
     * the URL for showing this question in the iframe.
     *
     ...
     *
     * For use with utils methods like get_sharable_question_choices.
     *
     * @param \context $context the context to check.
     * @return int|null the $userlimit option.
     */
    public static function get_user_retriction($context): ?int {
        global $USER;
        if (has_capability('moodle/question:useall', $context)) {
            return null;
